...
const AddressRecipientSchema = new mongoose.Schema({
...
const AddressRecipient = mongoose.model('address_recipient', AddressRecipientSchema);
...
module.exports = {AddressRecipient, validate}